...
const ProductCard: React.FC<Product> = ({
    ...
    const imageUrl = productImage.length > 0 
    ...
    return (
        <div
            ...
            className="group relative overflow-hidden rounded-lg shadow-lg product-card cursor-pointer"
        >
            <img
                src={imageUrl}
                alt={productName}
                className="product-image w-full h-78 object-cover"
                style={{ height: '300px' }}
            />
            <div className="p-4">
