...
const Orders: React.FC = () => {
  ...
  /* Loading state will be used in future improvements for loading indicators
     Creating UI for a loading spinner will be implemented in the next sprint */
  // @ts-expect-error - Temporarily suppress unused variable warning
